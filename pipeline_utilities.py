...
class FeatureImageTypes(Enum):
    ...
    T1_INTENSITY = 3
    T2_INTENSITY = 4
    T1_GRADIENT_INTENSITY = 5
    T2_GRADIENT_INTENSITY = 6
#    T1_NEIGHBOR = 4
    T1_LAPLACIAN = 7
    T2_LAPLACIAN = 8
    T1_DISGAUSS = 9
...
class FeatureExtractor:
    ...
    def execute(self) -> structure.BrainImage:
        ...
        if self.coordinates_feature:
            ...
            self.img.feature_images[FeatureImageTypes.ATLAS_COORD2] = \
        ...
        if self.discrete_gauss_feature:
            self.img.feature_images[FeatureImageTypes.T1_DISGAUSS] = \
                sitk.DiscreteGaussian(self.img.images[structure.BrainImageTypes.T1])
            self.img.feature_images[FeatureImageTypes.T2_DISGAUSS] = \
